...
// Student type formatter
export const getStudentTypeText = (type: string): string => {
  switch (type) {
    case 'adult':
      return 'Adult';
    case 'kids':
...
// Plan frequency formatter
export const getPlanFrequencyText = (frequency: string): string => {
  switch (frequency) {
    case '1_week':
      return '1 Week';
    case '2_week':
